...
max_frequency_hz = 100         # Creates 1_hz, 2_hz, ..., max_frequency_hz_hz
trials_per_frequency = 10     # Creates trial_1.pwl, ..., trial_j.pwl
...
def main() -> None:
    ...
    for st_index in range(1, num_spike_train_sets + 1):
        ...
        for frequency_hz in range(1, max_frequency_hz + 1):
